...
public class Messages_MenuMdc_CheckBox {
    String ContenueMsg;
    String Date;
    String Heure;
    String IDmsg;
    ...
    public Messages_MenuMdc_CheckBox(String IDMsg, String contenueMsg, String date, String heure, String nom_Prenom_Mdc, Boolean selected) {
        IDmsg = IDMsg;
