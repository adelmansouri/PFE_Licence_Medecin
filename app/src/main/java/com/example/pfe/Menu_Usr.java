...
public class Menu_Usr extends AppCompatActivity {

    DrawerLayout mDrawerLayout;
    ActionBarDrawerToggle mToggle;
    TextView Nom_Usr_Profil, Prenom_Usr_Profil, AdrMail_Usr_Profil, DateDeNaissance_Usr_Profil, Sexe_Usr_Profil, NumTel_Usr_Profil, NoFav_TV_ProfilUsr, NoMsg_TV_ProfilUsr, NoRDV_TV_ProfilUsr,NoMdc_TV_ProfilUsr_SearchAdv;
    ...
    ListView Liste_mdc, Liste_Favoris, Liste_Messages, Liste_RDV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu__usr);
    ...
    private NavigationView.OnNavigationItemSelectedListener Navigation_MenuUsr = new NavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.DesactiverCompte_Usr_btn :
                    if (AsyncTask_ArrierePlan.getStatus() != ArrierePlanSetInfo.Status.FINISHED) {
                        AsyncTask_ArrierePlan.cancel(true);
                    }
            ...
            try {
                ...
                switch (resultat) {
                    ...
                    case "Message Supprime" :
                        Toast.makeText(Menu_Usr.this, "Messages Supprimés", Toast.LENGTH_LONG).show();
                        break;

                    case "Medecin Supprime des Favoris" :
                        Toast.makeText(Menu_Usr.this, "Medecin Supprimer", Toast.LENGTH_LONG).show();
                        break;

                    case "Compte desactiver" :
                        Toast.makeText(Menu_Usr.this, "Compte désactivé", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(getApplicationContext(),MainActivity.class));
                        break;

                    case "Compte non desactive" :
                        Toast.makeText(Menu_Usr.this, "Problème dans la désactivation du compte", Toast.LENGTH_LONG).show();
