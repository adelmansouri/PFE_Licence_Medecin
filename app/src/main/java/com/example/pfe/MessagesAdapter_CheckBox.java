...
public class MessagesAdapter_CheckBox extends ArrayAdapter<Messages_MenuUsr_CheckBox> {

    ArrayList<Messages_MenuUsr_CheckBox> MessageListe;
    Context Ctxt;
    int mRessource;

    public MessagesAdapter_CheckBox(Context context, int resource, ArrayList<Messages_MenuUsr_CheckBox> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.SpecialiteMdc.setText(MessageListe.get(position).getSpecialitéMdc());
