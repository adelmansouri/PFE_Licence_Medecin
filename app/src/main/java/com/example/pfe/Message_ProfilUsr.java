...
public class Message_ProfilUsr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message__profil_usr);
        ...
        SpecialiteMdc_Msg = findViewById(R.id.SpecialiteMdc_MessageMdc);
        ...
        String NomPrenomMdc_MessageMdc = intent.getStringExtra(Menu_Usr.NomPrenomMdc_Msg);
        String SpeacialiteMdc_MessageMdc = intent.getStringExtra(Menu_Usr.SpecialiteMdc_Msg);
        String Contenue_MessageMdc = intent.getStringExtra(Menu_Usr.Contenue_Msg);
        String Date_MessageMdc = intent.getStringExtra(Menu_Usr.Date_Msg);
        String Heure_MessageMdc = intent.getStringExtra(Menu_Usr.Heure_Msg);
        IDUsr_MessageMdc = intent.getStringExtra(Menu_Usr.IDUsr_RpdMsg);
        IDMdc_MessageMdc = intent.getStringExtra(Menu_Usr.IDMdc_RpdMsg);

        NomPrenomMdc_Msg.setText(NomPrenomMdc_MessageMdc);
        SpecialiteMdc_Msg.setText(SpeacialiteMdc_MessageMdc);
            ...
            switch (Operation){
                case "RepondreMsg" :
                    try {
                        ...
                        String Envoi_Msg_Url = "http://192.168.1.9:8080/RepondMsg_Usr.php";
            ...
            try{
                ...
                switch (resultat){
                    case "Message envoyer":
                        Toast.makeText(Message_ProfilUsr.this, "Message envoyé", Toast.LENGTH_LONG).show();
                        break;

                    case "Message non envoyer":
                        Toast.makeText(Message_ProfilUsr.this, "Problème dans l'envoi de message", Toast.LENGTH_LONG).show();
                        break;
                }
